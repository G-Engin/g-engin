...
$imgB = _GEng_ImageLoad("res\tanks\images\Level1.png")
$imgT = _GEng_ImageLoad("res\tanks\images\tank_v.png")
$imgMg = _GEng_ImageLoad("res\tanks\images\mg.png")
$imgObus = _GEng_ImageLoad("res\tanks\images\shot.png")
$imgBalle = _GEng_ImageLoad("res\tanks\images\balle.png")
$imgSmoke = _GEng_ImageLoad("res\tanks\images\smoke.png", 576/2, 24)
$imgMuz = _GEng_ImageLoad("res\tanks\images\muz.png", 18, 14)
$imgExpSm = _GEng_ImageLoad("res\tanks\images\expSmall.png")
$imgExpBg = _GEng_ImageLoad("res\tanks\images\expBig.png")
$imgBlood = _GEng_ImageLoad("res\tanks\images\Blood.png")
$imgMine = _GEng_ImageLoad("res\tanks\images\Mine.png")
$imgCrosshair = _GEng_ImageLoad("res\tanks\images\Crosshair.png")
$imgMarine = _GEng_ImageLoad("res\tanks\images\Enemy.png")
$imgRocket = _GEng_ImageLoad("res\tanks\images\EnemyRocket.png")
$imgHealthbarBack = _GEng_ImageLoad("res\tanks\images\HealthbarBack.png")
$imgHealthbar = _GEng_ImageLoad("res\tanks\images\Healthbar.png")
$imgHealthbarNeg = _GEng_ImageLoad("res\tanks\images\HealthbarNeg.png")
$imgMenuBar = _GEng_ImageLoad("res\tanks\images\BottomMenu.png")
; ---
